...
height = st.number_input("กรุณาป้อน ส่วนสูง สำหรับคำนวน BMI (m):")
weight = st.number_input("กรุณาป้อน น้ำหนัก สำหรับคำนวน BMI (kg):")
...
if st.button("พยากรณ์ข้อมูล"):
    ...
    if y_predict == 1:
        st.warning("มีความเสียงเป็นเบาหวาน", icon="⚠️")
    else:
        st.success("ไม่มีความเสี่ยง / ปกติ", icon="✅")
